  ...
  angular.module("ng-pagination", [])
    .constant('ngPaginationConfig', {
      ...
      return {
        ...
        '<li class="prevText"  ng-click="pageChange(currentPage-1>0?currentPage-1:1)">{{prevText}}</li>' +
        ...
        '<li class="showGoto"><lable ng-if="showGoto">{{gotoText}}</label><input type="text" ng-keyup="keyupHanlder($event)"><span class="pageCount">/{{pageCount}}<span></li></ul></div>'
      }
    }]);
})(angular);
